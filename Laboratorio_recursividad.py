...
def contar_fotos(ruta, cola,extensiones):
    ...
    try:
        for elemento in os.listdir(ruta):
            ...
            if os.path.isfile(camino):
                ...
                total += contar_fotos(camino, cola,extensiones)
    except PermissionError:
...
def ppal():
    ruta_principal = input("Ingrese la ruta de la carpeta principal: ").strip()
    cola_carpetas = Cola()


    extensiones = (".jpg", ".jpeg", ".png", ".gif",".ico")

    total_fotos = contar_fotos(ruta_principal, cola_carpetas,extensiones)
